        ...
        if data is not None:
            ...
            if st.checkbox('Display Pie Chart'):
                ...
                pie_columns = st.selectbox(
                    "select column to display", all_columns)
        ...
        if data is not None:
            ...
            if st.checkbox('Select Multiple columns'):
                new_data = st.multiselect(
                    "Select your preferred columns. NB: Let your target variable be the last column to be selected", df.columns)
                df1 = df[new_data]
                st.dataframe(df1)
            ...
            classifier_name = st.sidebar.selectbox(
                'Select your preferred classifier:', ('KNN', 'SVM', 'LR', 'naive_bayes', 'decision tree'))
...
# DELING WITH THE ABOUT US PAGE
        ...
        st.markdown('This is an interactive web page for my ML project. This dataset is fetched from the UCI Machine learning repository.'
                    )
